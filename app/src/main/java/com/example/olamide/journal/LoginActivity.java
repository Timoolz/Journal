    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(LoginActivity.this, "YOU HAVE CLICKED SIGNUP",Toast.LENGTH_SHORT).show();
                signIn();
            }
        });
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(firebaseAuth.getCurrentUser() != null){
                    ...
                    Toast.makeText(LoginActivity.this, "Google sign SUCCESSFUL  " +
                            firebaseAuth.getCurrentUser().getDisplayName(),Toast.LENGTH_LONG).show();

                    Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                    //intent.putExtra(FIREBASE_USER, (Serializable) firebaseAuth);
